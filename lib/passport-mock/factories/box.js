...
module.exports = function Box (params) {
  ...
  var json = {
    ...
    created_at: params.created_at || moment(new Date()).format('YYYY-MM-DDTHH:mm:ssZ'),
    modified_at: params.updated_at || moment(new Date()).format('YYYY-MM-DDTHH:mm:ssZ'),
  ...
  return {
    ...
    photos: [ { value: 'https: //app.box.com/api/avatar/large/233660060' } ],
    login: json.login,
