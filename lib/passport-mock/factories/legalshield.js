...
module.exports = function Legalshield (params) {
  console.log("****FAKER*****", faker.address);
  params = params || { };
  ...
  var json = {
    Member: {
      ...
      _json: {
        ...
        email_address: email,
        access_control: {
          allow_emergency_access: (params.access_control.allow_emergency_access || true),
          allow_will_preparation: (params.access_control.allow_will_preperation || true),
          allow_idshield_dashboard: (params.access_control.allow_idshield_dashboard || false),
          allow_speeding_ticket_upload: (params.access_control.allow_speeding_ticket_upload || true),
          allow_member_perks: (params.access_control.allow_member_perks || true)
        },
        address: {
    ...
    basic_profile: {
      ...
      first_name: null,
      last_name: null,
      is_member: (params.is_member || true),
